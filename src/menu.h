...
void draw_menu_list(SDL_Renderer* renderer, Viewport* viewport, MenuList* list);
...
void draw_menu_select(SDL_Renderer* renderer, Viewport* viewport, MenuSelect* select);
...
void draw_menu_button(SDL_Renderer* renderer, Viewport* viewport, MenuButton* button);
...
void draw_menu_spacer(SDL_Renderer* renderer, Viewport* viewport, MenuSpacer* spacer);
