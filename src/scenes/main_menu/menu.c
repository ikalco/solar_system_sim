...
MenuNode *init_menu_sub_list(MenuNode *root_node) {
	...
	MenuNode *sub_list_node = create_menu_node(SUB_LIST,
											   (VectorD){0, 0},
	...
	MenuButton *create_button =
		create_menu_button(button_color,
						   text_color,
						   TEXT_CENTER,
						   create_string("Create Solar System"));
	MenuNode *create_button_node =
		create_menu_node(CREATE_BUTTON,
						 (VectorD){0, 0},
	...
	MenuButton *load_button =
		create_menu_button(button_color,
						   text_color,
						   TEXT_CENTER,
						   create_string("Load Solar System"));
	MenuNode *load_button_node = create_menu_node(LOAD_BUTTON,
												  (VectorD){0, 0},
												  (VectorD){MENU_MAX_SIZE, 60},
												  sub_list_node,
												  MENU_BUTTON,
	...
	MenuNode *settings_button_node =
		create_menu_node(SETTINGS_BUTTON,
						 (VectorD){0, 0},
						 (VectorD){MENU_MAX_SIZE, 60},
						 sub_list_node,
						 MENU_BUTTON,
...
MenuRoot *init_main_menu_root(SDL_Window *window) {
	...
	MenuNode *title_text_node = create_menu_node(MENUTEXT,
												 (VectorD){0, 0},
	...
	MenuButton *exit_button = create_menu_button((Color){240, 10, 10, 255},
												 text_color,
												 TEXT_CENTER,
												 create_string("Exit"));
	MenuNode *exit_button_node = create_menu_node(EXIT_BUTTON,
												  (VectorD){0, 0},
												  (VectorD){120, 50},
												  root_node,
												  MENU_BUTTON,
